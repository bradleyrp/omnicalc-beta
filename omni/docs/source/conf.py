...
#---additions by rpb
sys.path.insert(0, os.path.abspath("../../.."))
#---started this documentation with: rm -r *;sphinx-apidoc -F -o . ../../omni
...
latex_documents = [
  (master_doc, 'omni.tex', u'omni Documentation',
   u'Author', 'manual'),
]
...
man_pages = [
    (master_doc, 'omni', u'omni Documentation',
     [author], 1)
]
...
texinfo_documents = [
  (master_doc, 'omni', u'omni Documentation',
   author, 'omni', 'One line description of project.',
   'Miscellaneous'),
]
